...
export default function EvolutionPageNew() {
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="space-y-1">
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-medium">{card.xp}/{card.maxXp}</span>
                        </div>
                          ...
                          <div key={stage} className="flex items-center">
                            <div
                              className={`flex flex-col items-center ${
                                index < stageOrder.length - 1 ? "flex-1" : ""
                              }`}
                            >
                              <div
                    ...
                    {previewStage && (
                      <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl">
                        <div className="text-center">
                          ...
                          <div
                            className={`w-32 h-32 mx-auto rounded-2xl bg-gradient-to-br ${getElementColor(
                    ...
                    {canEvolve ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-600">
                          This creature is at Elder stage and cannot evolve further.
                        </p>
                      </div>
                    )}
                  </CardContent>
